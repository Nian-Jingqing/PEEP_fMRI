 ...
 Screen('Textsize',P.display.w,50);
        ...
        if length(preExpInts)>1
            ...
            if ~O.debug.toggleVisual
                if strcmp(P.language,'de')
                    [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, 'War dieser Reiz (mindestens) LEICHT SCHMERZHAFT fÃ¼r Sie?', 'center', upperEight, P.style.white);
                    [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ['Falls ja, drÃ¼cken Sie bitte ' keyPainful '.'], 'center', upperEight+P.lineheight, P.style.white);            
                    [P.display.screenRes.width, upperEight]=DrawFormattedText(P.display.w, ['Falls nein, drÃ¼cken Sie bitte ' keyNotPainful '.'], 'center', upperEight+P.lineheight+5, P.style.white);            
                elseif strcmp(P.language,'en')
