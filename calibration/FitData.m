% Fits the data in a linear fashion
%
% Input:
%   - x: pressure data (non zero) from previous calibration step
%   - y: rating data (non-zero) VAS ratings from previous calibration step
...
% 
% 
% script by Björn Horing, modified by Karita Ojala 2021-05-06, 
% modified again by Janne Nold 2021-11-10
