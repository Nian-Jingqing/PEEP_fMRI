function [abort,finalRating,reactionTime,keyId,keyTime,response] = singleratingScale_bigger_wider(P,ratingsection)
...
lowlowLabelRect             = [axesRect(1),yCenter-30,axesRect(1)+12,yCenter+30];
...
while numberOfSecondsRemaining  > 0
    ...
    Screen('FillRect',window,scaleColor,lowlowLabelRect);
    ...
    elseif ratingsection == 2
        ...
        Screen('DrawText',window,'Druck',axesRect(1)-150,yCenter+40,scaleColor);
        Screen('DrawText',window,'gespürt',axesRect(1)-100,yCenter+80,scaleColor);

        %Screen('DrawText',window,'minimaler',axesRect(1)-100,yCenter+40,scaleColor);
        %Screen('DrawText',window,'Schmerz',axesRect(1)-80,yCenter+80,scaleColor);
